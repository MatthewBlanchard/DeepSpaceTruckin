    ...
    for line in love.filesystem.lines(path) do
        ...
        elseif firstWord == "f" then
            ...
            if #words == 5 then
                ...
                local tri1 = {
                    v = { face.v[1], face.v[2], face.v[3] },
                    vt = { face.vt[1], face.vt[2], face.vt[3] },
                    n = { face.n[1], face.n[2], face.n[3] }
                }

                local tri2 = {
                    v = { face.v[1], face.v[3], face.v[4] },
                    vt = { face.vt[1], face.vt[3], face.vt[4] },
                    n = { face.n[1], face.n[3], face.n[4] }
